...
import nova.network.neutronv2
import nova.network.security_group.openstack_driver
import nova.tests.api.gce.fake_image as fake_image
import nova.tests.api.gce.fake_instance as fake_instance
import nova.tests.api.gce.fake_network as fake_network
import nova.tests.api.gce.fake_project as fake_project
import nova.tests.api.gce.fake_request as fake_request
import nova.tests.api.gce.fake_security_group as fake_security_group
import nova.tests.api.gce.fake_volume as fake_volume
import nova.tests.api.gce.fake_zone as fake_zone
...
class GCEControllerTest(test.TestCase):
    ...
    def setUp(self):
        ...
        self.stubs.Set(nova.network.neutronv2, "get_client",
